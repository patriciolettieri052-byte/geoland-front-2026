...
export const FINANCIAL_VARS_CONFIG: Record<string, Array<{
  ...
  FIX_FLIP: [
    ...
    { label: "ROI total",      field: "roiTotal",               format: "percent",  positive: "high", showBar: true, barMax: 150 },
    { label: "IRR equiv.",     field: "irr_equivalente",        format: "percent",  positive: "high", showBar: true, barMax: 0.35 },

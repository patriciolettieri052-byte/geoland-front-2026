...
• AUTO-CONFIRMACIÓN: Si el perfil está completo y el usuario dice "ver opciones", "adelante", "todos" o similares, marca confirmed_by_user: true e isv_sufficient: true inmediatamente sin volver a preguntar.

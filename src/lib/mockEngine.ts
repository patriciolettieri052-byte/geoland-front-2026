    ...
    assets: [
        {
            ...
            nombre: 'Palacio Alcalá - Reforma Integral',
            location: 'Madrid Centro · Calle Alcalá, España',
            confidence: 0.88,
            etiqueta_operacion: "Oportunidad de alta rentabilidad",
            ...
            layer1: {
                ...
                liquidity: "Media",
                riskLevel: "Bajo",
                rationale: 'Oportunidad de reforma integral en zona premium con alta demanda y absorción récord',
                backgroundImageUrl: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2',
            },
            layer2: {
                metrics: { roiTotal: 0.224, netMargin: 0.18, baseCapex: 450000 },
            ...
            margen_bruto: 24.5,
            meses_obra: 8,
            estado_actual: 'Para reformar',
            payback_meses: 9,
        },
        {
            id: 'asset-agriculture-bsas-1',
            strategy: 'agriculture',
            nombre: 'Estancia La Pampa - Productividad Premium',
            location: 'Buenos Aires · Pampa Húmeda, Argentina',
            confidence: 0.92,
            etiqueta_operacion: "Excelente rinde para soja",
            market_context_version: "v2",
            trace_id: null,
            clase_coneat: 145,
            ...
            layer1: {
                ...
                liquidity: "Baja",
                riskLevel: "Bajo",
                rationale: 'Terreno con excelente productividad y acceso a riego complementario para doble cosecha',
                backgroundImageUrl: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad576',
            },
            layer2: {
                metrics: { roiTotal: 0.142, netMargin: 0.12, baseCapex: 1200000 },
                sensitivityConfig: { capexRange: [1000000, 1500000], exitRateRange: [5.0, 7.0] },
            },
            layer3: {
                documents: []
            },
            photo_urls: [
                ...
                'https://images.unsplash.com/photo-1444858291040-58ea7da53e89',
